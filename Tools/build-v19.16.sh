...
test ! -e "$quest_project_root/Builds/Purgatory-v19.16-stars-atmosphere.apk"
mkdir -p "$quest_project_root/Verification/Atmosphere"
export QDMR_GRADLE_EXPORT
QDMR_GRADLE_EXPORT=$(mktemp -d /private/tmp/qdmr-v1916-export.XXXXXX)
...
bash "$quest_project_root/Tools/package-v19.16.sh" "$QDMR_GRADLE_EXPORT"
