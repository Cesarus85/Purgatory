...
test ! -e "$quest_project_root/Builds/Purgatory-v19.19-combat-director.apk"
mkdir -p "$quest_project_root/Verification/V19Completion"
export QDMR_GRADLE_EXPORT
QDMR_GRADLE_EXPORT=$(mktemp -d /private/tmp/qdmr-v1919-export.XXXXXX)
quest_build_log="$quest_project_root/Verification/V19Completion/unity-$(basename "$QDMR_GRADLE_EXPORT").log"
...
bash "$quest_project_root/Tools/package-v19.19.sh" "$QDMR_GRADLE_EXPORT"
