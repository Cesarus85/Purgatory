...
test ! -e "$quest_project_root/Builds/Purgatory-v19.18-creature-polish.apk"
mkdir -p "$quest_project_root/Verification/CreaturePolish"
export QDMR_GRADLE_EXPORT
QDMR_GRADLE_EXPORT=$(mktemp -d /private/tmp/qdmr-v1918-export.XXXXXX)
quest_build_log="$quest_project_root/Verification/CreaturePolish/unity-$(basename "$QDMR_GRADLE_EXPORT").log"
...
bash "$quest_project_root/Tools/package-v19.18.sh" "$QDMR_GRADLE_EXPORT"
