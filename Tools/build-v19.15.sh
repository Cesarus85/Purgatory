...
test ! -e "$quest_project_root/Builds/Purgatory-v19.15-presence.apk"
mkdir -p "$quest_project_root/Verification/Presence"
export QDMR_GRADLE_EXPORT
QDMR_GRADLE_EXPORT=$(mktemp -d /private/tmp/qdmr-v1915-export.XXXXXX)
quest_build_log="$quest_project_root/Verification/Presence/unity-$(basename "$QDMR_GRADLE_EXPORT").log"
...
bash "$quest_project_root/Tools/package-v19.15.sh" "$QDMR_GRADLE_EXPORT"
