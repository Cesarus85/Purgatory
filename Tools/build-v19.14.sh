...
test ! -e "$quest_project_root/Builds/Purgatory-v19.14-heaven-spread-entry.apk"
mkdir -p "$quest_project_root/Verification/Immersion"
export QDMR_GRADLE_EXPORT
QDMR_GRADLE_EXPORT=$(mktemp -d /private/tmp/qdmr-v1914-export.XXXXXX)
quest_build_log="$quest_project_root/Verification/Immersion/unity-$(basename "$QDMR_GRADLE_EXPORT").log"
...
bash "$quest_project_root/Tools/package-v19.14.sh" "$QDMR_GRADLE_EXPORT"
